...
> [!note] 相關閱讀
>
> - [[AI 代理工作流實戰：從模糊需求到 Develop Done 的完整閉環]] — Spec-Driven 流程在實戰閉環的具體展開
> - [[從 Prompt 到系統：用 Claude Code 打造 AI 開發閉環的五層架構設計]] — 同主題的另一種分層視角
> - [[gstack — 把 Claude Code 變成虛擬工程團隊的開源框架]] — 六大方案之一
> - [[OpenSpec 使用指南：Spec-Driven 開發工作流]] — OpenSpec 工具實務
